...
var _MatSelect = class _MatSelect {
  ...
  constructor(_viewportRuler, _changeDetectorRef, _unusedNgZone, defaultErrorStateMatcher, _elementRef, _dir, parentForm, parentFormGroup, _parentFormField, ngControl, tabIndex, scrollStrategyFactory, _liveAnnouncer, _defaultOptions) {
    ...
    this._panelDoneAnimatingStream = new import_rxjs3.Subject();
    ...
    this._initialized = new import_rxjs3.Subject();
    this.optionSelectionChanges = (0, import_rxjs3.defer)(() => {
    ...
    this._openedStream = this.openedChange.pipe((0, import_operators3.filter)((o) => o), (0, import_operators3.map)(() => {
    }));
    this._closedStream = this.openedChange.pipe((0, import_operators3.filter)((o) => !o), (0, import_operators3.map)(() => {
    }));
  ...
  ngOnInit() {
    ...
    this.stateChanges.next();
    this._panelDoneAnimatingStream.pipe((0, import_operators3.distinctUntilChanged)(), (0, import_operators3.takeUntil)(this._destroy)).subscribe(() => this._panelDoneAnimating(this.panelOpen));
